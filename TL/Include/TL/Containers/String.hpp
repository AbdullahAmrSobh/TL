...
namespace TL
{
    ...
    using StringView    = BasicStringView<char>;     //, std::char_traits<char>, StlAllocatorAdapter<char, Allocator>>;
    using WStringView   = BasicStringView<wchar_t>;  //, std::char_traits<wchar_t>, StlAllocatorAdapter<wchar_t, Allocator>>;
    using U8stringView  = BasicStringView<char8_t>;  //, std::char_traits<char8_t>, StlAllocatorAdapter<char8_t, Allocator>>;
    using U16stringView = BasicStringView<char16_t>; //, std::char_traits<char16_t>, StlAllocatorAdapter<char16_t, Allocator>>;
    using U32stringView = BasicStringView<char32_t>; //, std::char_traits<char32_t>, StlAllocatorAdapter<char32_t, Allocator>>;
